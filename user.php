...
<html lang="en">
  ...
  <body>
	...
	$userStatsDailyCount = $db->querySingle("SELECT COUNT(distinct title) FROM processed WHERE datetime(stopped, 'unixepoch', 'localtime') >= date('now', 'localtime') AND user='$user' ");
	...
	$userStatsWeeklyCount = $db->querySingle("SELECT COUNT(distinct title) FROM processed WHERE datetime(stopped, 'unixepoch') >= datetime('now', '-7 days', 'localtime') AND user='$user' ");
	...
	$userStatsMonthlyCount = $db->querySingle("SELECT COUNT(distinct title) FROM processed WHERE datetime(stopped, 'unixepoch', 'localtime') >= datetime('now', '-30 days', 'localtime') AND user='$user' ");
	...
	$userStatsAlltimeCount = $db->querySingle("SELECT COUNT(distinct title) FROM processed WHERE user='$user' ");
